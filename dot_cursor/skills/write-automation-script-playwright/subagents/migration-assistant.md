...
- Cypress root: `/Users/ashafi/Documents/work/automation/qe-automation-repos/clc-ui`
- Playwright root: `/Users/ashafi/Documents/work/automation/qe-automation-repos/console-e2e`
- Playwright architecture: `~/.cursor/skills/write-automation-script-playwright/references/architecture-summary.md`
- Migration guide (if present): search `automation/documentation/` for `*migration*` — `documentation/playwright/` path may not exist
- Framework patterns: `~/.cursor/skills/write-automation-script-playwright/framework/playwright-patterns.md`
...
| `cypress/views/actions/{area}.js` | `src/services/OcCliService.ts` (add domain-prefixed methods) or `src/lib/{area}/` (multi-step flows) |
