...
Return ONLY the structured format below. No prose explanations, no summaries of what you did, no commentary. The parent agent needs data, not narrative. Target: under 400 words total output.
